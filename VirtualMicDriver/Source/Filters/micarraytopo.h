...
#ifndef _VirtualMic_MICARRAYTOPO_H_
#define _VirtualMic_MICARRAYTOPO_H_
...
class CMicArrayMiniportTopology :
    public CMiniportTopologyVirtualMic,
...
public:
    ...
    (
        ...
        CMiniportTopologyVirtualMic(FilterDesc, DeviceMaxChannels),
...
#endif // _VirtualMic_MICARRAYTOPO_H_
