...
#ifndef _VirtualMic_MICARRAYWAVTABLE_H_
#define _VirtualMic_MICARRAYWAVTABLE_H_

// Forward declaration of property handler
NTSTATUS
PropertyHandler_Sideband
(
...
// Mic array range.
//
#define MICARRAY_RAW_CHANNELS                   1       // 1 channel (Mono)
#define MICARRAY_DEVICE_MAX_CHANNELS            1       // Max channels
#define MICARRAY_16_BITS_PER_SAMPLE_PCM         16      // 16 Bits Per Sample
#define MICARRAY_RAW_SAMPLE_RATE                44100   // 44.1kHz sample rate
...
static
VirtualMic_PROPERTY_ITEM PropertiesMicArrayWaveFilter[] =
{
    {
        {
            &KSPROPSETID_General,
    ...
    {
        {
            &KSPROPSETID_VirtualMic_Sideband,
            KSPROPERTY_SIDEBAND_PUSH_MIC_DATA,
            KSPROPERTY_TYPE_SET | KSPROPERTY_TYPE_BASICSUPPORT,
            PropertyHandler_Sideband,
        },
        0,
...
#endif // _VirtualMic_MICARRAYWAVTABLE_H_
