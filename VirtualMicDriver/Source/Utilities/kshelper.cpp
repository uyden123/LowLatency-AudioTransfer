...
Abstract:
    ...
    Helper functions for Virtual Mic
--*/
...
#pragma code_seg("PAGE")
NTSTATUS
VirtualMicPropertyDispatch
(
    _In_ PPCPROPERTY_REQUEST PropertyRequest
)
/*++
    Handles and dispatches a VirtualMic_PROPERTY_ITEM.

    Use this as the property handler only if the property item is a
    VirtualMic_PROPERTY_ITEM.
--*/
{
    PAGED_CODE();

    VirtualMic_PROPERTY_ITEM* item = (VirtualMic_PROPERTY_ITEM*)PropertyRequest->PropertyItem;
