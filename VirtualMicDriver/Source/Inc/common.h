...
#ifndef _VirtualMic_COMMON_H_
#define _VirtualMic_COMMON_H_
...
//
//=============================================================================
typedef struct _VirtualMic_DEVPROPERTY {
    const DEVPROPKEY   *PropertyKey;
    DEVPROPTYPE Type;
    ULONG BufferSize;
    __field_bcount_opt(BufferSize) PVOID Buffer;
} VirtualMic_DEVPROPERTY, PVirtualMic_DEVPROPERTY;
...
typedef struct _ENDPOINT_MINIPAIR 
{
    ...
    // Topology miniport.
    PWSTR                           TopoName;               // make sure this or the template name matches with VirtualMic.<TopoName>.szPname in the inf's [Strings] section
    ...
    const VirtualMic_DEVPROPERTY*       TopoInterfaceProperties;

    // Wave RT miniport.
    PWSTR                           WaveName;               // make sure this or the template name matches with VirtualMic.<WaveName>.szPname in the inf's [Strings] section
    ...
    const VirtualMic_DEVPROPERTY*       WaveInterfaceProperties;
