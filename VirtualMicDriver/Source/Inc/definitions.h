...
#ifndef _VirtualMic_DEFINITIONS_H_
#define _VirtualMic_DEFINITIONS_H_
...
#define STATIC_PID_VirtualMic\
    0x836ba6d1, 0x3ff7, 0x4411, 0x8b, 0xcd, 0x46, 0x95, 0x53, 0x45, 0x2d, 0xce
DEFINE_GUIDSTRUCT("836BA6D1-3FF7-4411-8BCD-469553452DCE", PID_VirtualMic);
#define PID_VirtualMic DEFINE_GUIDNAMED(PID_VirtualMic)

// {C22E60E6-764E-40E9-9630-67A01603F292}
#define STATIC_KSPROPSETID_VirtualMic_Sideband\
    0xc22e60e6, 0x764e, 0x40e9, 0x96, 0x30, 0x67, 0xa0, 0x16, 0x03, 0xf2, 0x92
DEFINE_GUIDSTRUCT("C22E60E6-764E-40E9-9630-67A01603F292", KSPROPSETID_VirtualMic_Sideband);
#define KSPROPSETID_VirtualMic_Sideband DEFINE_GUIDNAMED(KSPROPSETID_VirtualMic_Sideband)

enum {
    KSPROPERTY_SIDEBAND_PUSH_MIC_DATA = 0
};

// Pool tag used for VirtualMic allocations
#define VirtualMic_POOLTAG               'SASM'  

// Debug module name
#define STR_MODULENAME              "VirtualMic: "
...
#endif // _VirtualMic_DEFINITIONS_H_
