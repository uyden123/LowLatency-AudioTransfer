...
#ifndef _VirtualMic_MINWAVERT_H_
#define _VirtualMic_MINWAVERT_H_
...
#pragma code_seg("PAGE")
        ...
        m_pMiniportPair(MiniportPair)
    {
        ...
        if (MiniportPair->WaveDescriptor)
        {
            ...
            //
            // Capture-only driver: no render device support
            if (IsRenderDevice())
            {
                // No render pins
            }
...
#pragma code_seg()
    ...
    friend class        CMiniportTopologyVirtualMic;
...
#pragma code_seg()
    BOOL IsRenderDevice()
    {
        // No render/speaker device in this driver
        return FALSE;
    }
...
#endif // _VirtualMic_MINWAVERT_H_
