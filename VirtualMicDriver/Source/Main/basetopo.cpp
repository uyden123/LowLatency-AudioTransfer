...
CMiniportTopologyVirtualMic::CMiniportTopologyVirtualMic
(
...
#pragma code_seg("PAGE")
NTSTATUS
CMiniportTopologyVirtualMic::DataRangeIntersection
( 
    _In_  ULONG                 PinId,
...
#pragma code_seg("PAGE")
NTSTATUS
CMiniportTopologyVirtualMic::GetDescription
( 
...
#pragma code_seg("PAGE")
NTSTATUS
CMiniportTopologyVirtualMic::Init
( 
...
--*/
{
    ...
    DPF_ENTER(("[CMiniportTopologyVirtualMic::Init]"));
...
#pragma code_seg("PAGE")
NTSTATUS                            
CMiniportTopologyVirtualMic::PropertyHandlerGeneric
(
...
#pragma code_seg("PAGE")
NTSTATUS                            
CMiniportTopologyVirtualMic::PropertyHandlerMuxSource
(
    _In_  PPCPROPERTY_REQUEST     PropertyRequest
)
/*++
...
#pragma code_seg("PAGE")
NTSTATUS                            
CMiniportTopologyVirtualMic::PropertyHandlerDevSpecific(
    _In_  PPCPROPERTY_REQUEST     PropertyRequest
)
/*++
...
#pragma code_seg("PAGE")
VOID
CMiniportTopologyVirtualMic::AddEventToEventList
(
...
#pragma code_seg()
VOID
CMiniportTopologyVirtualMic::GenerateEventList
(
    _In_opt_    GUID   *Set,
    _In_        ULONG   EventId,
    _In_        BOOL    PinEvent,
...
--*/
{
    DPF_ENTER(("[CMiniportTopologyVirtualMic::GenerateEventList]"));
